...
function (BaseController, MessageToast, JSONModel, MessageBox, Filter, FilterOperator, Formatter) {
    ...
    return BaseController.extend("rm.webshop.test.controller.xdocbestilling", {
        
        // Define the constant user number (Needed for OData read)
        formatter: Formatter,
        ...
        onInit: function () {
            ...
            this.getOwnerComponent().getRouter().getRoute("Routexdocbestilling").attachPatternMatched(this._onRouteMatched, this);
        },
        ...
        _onRouteMatched: function (oEvent) {
            ...
            if (oIconTabBar) {
                oIconTabBar.setSelectedKey("HeadXOversigt");
            }
        ...
        _fetchUserData: function() {
            ...
            oODataModel.read(sPath, {
                ...
                success: function(oData) {
                    // Update the model properties that the view is bound to
                    ...
                    // Set address data for potential reuse in the order confirmation dialog
                    oViewModel.setProperty("/UserContact/address", {
                        streetName: oData.Street || "",
                        streetNr: oData.Housenum || "",
                        postalCode: oData.PostCode || "",
                        city: oData.City || ""
                    });
                }.bind(this),
                error: function(oError) {
        ...
        _createBasketItem: function(oPayload, sMaterialName) {
            ...
            return new Promise((resolve, reject) => {
                oODataModel.create(sPath, oPayload, {
                    ...
                    error: function(oError) {
                        // Error: We know exactly which item caused the error because of the loop.
